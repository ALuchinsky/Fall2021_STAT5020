...
Only 2014 year is required

```{r}
Dat <- filter(Dat, Year == 2014)
print_missing(Dat )
```
...
```{r}
write.csv(Dat_final, "../data/processed/prepared_data_2014.csv")
```
