...
```{r}
plot(xxx$R2, type = "o", ylim=c(0.785, 0.82), xlim = c(1, 20), xlab = NA, ylab = "R2")
lines(xxx$adjR2, type = "o", col="red")
legend("topright", legend = c("R2", "adjR2"), lty = 1, pch=1, col=c("black", "red"))
```
