...
% ## objectives
1.	To create a regression model for life expectancy based on the factors considered in the WHO data.
2.	To determine which factors are most correlated with life expectancy.
3.	To determine how changes in factors will impact life expectancy.
